                                  ...
                                  children: [
                                    ...
                                    Positioned(
                                      ...
                                      child: Container(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            Text(
                                              displayList[index].courseName.length >
                                                      20
                                                  ? displayList[index]
                                                          .courseName
                                                          .substring(0, 20) +
                                                      '...'
                                                  : displayList[index].courseName,
                                    ...
                                    Positioned(
                                      ...
                                      child: Container(
                                        ...
                                        width: 100.w,
                                        child: Center(
                                            child: Text(displayList[index].level)),
                                      ),
                                    )
                                  ],
                                ),
